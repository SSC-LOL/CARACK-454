...
os.system(f'xdg-open https://github.com/SSC-LOL/CARACK-454/blob/main/approval.%20txt')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/SSC-LOL/CARACK-454/blob/main/approval.%20txt).text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SSC-LOL/CARACK-454/blob/main/approval.%20txt').text
        ua=open('bbnew.txt','w')
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SSC-LOL/CARACK-454/blob/main/approval.%20txt).text
    if id in httpCaht:
      print(fuckyoursali)
    ...
    sys.exit()
meyexudi()
#os.system("python CARACK-454.py")
def naima():
	print('-------------------')
print(logo)
